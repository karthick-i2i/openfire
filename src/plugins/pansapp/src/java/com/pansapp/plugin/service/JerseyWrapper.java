...
import com.pansapp.plugin.exceptions.RESTExceptionMapper;
...
public class JerseyWrapper extends ServletContainer {
	...
	private static final String CUSTOM_AUTH_PROPERTY_NAME = "plugin.pansapp.customAuthFilter";
	
	/** The Constant REST_AUTH_TYPE */
	private static final String REST_AUTH_TYPE  = "plugin.pansapp.httpAuth";
	...
	private static final String SERVLET_URL = "pansapp/*";
	...
	public static String tryLoadingAuthenticationFilter(String customAuthFilterClassName) {
		...
		try {
			...
			loadingStatusMessage = "No custom auth filter found for pansapp plugin with name " + customAuthFilterClassName;
        }
	...
	public static String loadAuthenticationFilter() {
		...
		try {
			...
			loadingStatusMessage = "No custom auth filter found for pansapp plugin! " + customAuthFilterClassName + " " + restAuthType;
        }
